...
public class FacebookSignInProvider implements SignInProvider {
       ...
       // //@@@@@@@@@@ #1 reponse @@@@@@@@@@
        ...
        LoginManager.getInstance().registerCallback(facebookCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                long timeTaken = time2 - time1;
                System.out.println( "********************************************************************");
                System.out.println("Time taken to Sign-in successfully through Facebook " + timeTaken + " ns");
                System.out.println( "********************************************************************");
    ...
    /** {@inheritDoc} */
    @Override
    public boolean isUserSignedIn() {System.out.println(" %%% isUserSignedIn %%%");
        return getSignedInToken() != null;
    }

    /** {@inheritDoc} */
    @Override
    public String getToken() {  System.out.println(" %%% getToken %%%");
